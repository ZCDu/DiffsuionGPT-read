...
class Text2Image:
    ...
    # NOTE: 利用LLM将原始的SD模型说明转化为本文需要的tot形式
    def build_tree(self, model_tags):
        # tags_only对应的是模型对应的标签: "tag": ["futuristic", "clothing", "fashion design"],
    ...
    def inference(self, inputs):
        ...
        # NOTE: 使用大模型调整用户输入的语句，形成SD的prompt
...
class ConversationBot:
    ...
    def __init__(self, load_dict):
        ...
        # NOTE: 按道理来说，这里应该只有一个叫Text2Image的工具
        self.tools = []
        # FIXME: 感觉只需要修改Text2Image的inferernce函数即可
